...
import { onAuthStateChanged } from 'firebase/auth'; // 1. Tambahkan import ini
import { signIn, createAccount, deleteCurrentUser, getUserProfile, bootstrapStoreAccount } from '../lib/services/authService';
...
export default function AuthPanel({ mode = 'login' }) {
  ...
  useEffect(() => {
    // 2. Perbaiki penulisan fungsi onAuthStateChanged ke format Modular
